...
class Config(object):
    ...
    STATUS_COMMAND = os.environ.get("STATUS_COMMAND", "status@Devilvideobot")
    SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "save@Devilvideobot")
    CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "clear@Devilvideobot")
    UPLOAD_AS_DOC = os.environ.get("UPLOAD_AS_DOC", "False")
    PYTDL_COMMAND_G = os.environ.get("PYTDL_COMMAND_G", "pytdl")
    LOG_COMMAND = os.environ.get("LOG_COMMAND", "log@Devilvideobot")
