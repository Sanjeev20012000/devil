...
class Config(object):
    ...
    MAX_TG_SPLIT_FILE_SIZE = int(os.environ.get("MAX_TG_SPLIT_FILE_SIZE", 1950000000))
    ...
    STATUS_COMMAND = os.environ.get("STATUS_COMMAND", "status@Devilvideo2bot")
    SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "save@Devilvideo2bot")
    CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "clear@Devilvideo2bot")
    UPLOAD_AS_DOC = os.environ.get("UPLOAD_AS_DOC", "False")
    PYTDL_COMMAND_G = os.environ.get("PYTDL_COMMAND_G", "pytdl")
    LOG_COMMAND = os.environ.get("LOG_COMMAND", "log@Devilvideo2bot")
