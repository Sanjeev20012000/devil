...
if __name__ == "__main__" :
    ...
    incoming_purge_message_handler = MessageHandler(
        ...
        filters=Filters.command(["purge@Devilvideobot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    incoming_g_clear_handler = MessageHandler(
        g_clearme,
        filters=Filters.command(["renewme@Devilvideobot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    help_text_handler = MessageHandler(
        help_message_f,
        filters=Filters.command(["help@Devilvideobot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
